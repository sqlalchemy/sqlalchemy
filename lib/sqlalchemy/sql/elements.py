...
class ClauseElement(Visitable):
    ...
    def __and__(self, other):
        ...
        .. deprecated:: 0.9.5 - conjunctions are intended to be
           at the :class:`_expression.ColumnElement`. level
...
class TextClause(Executable, ClauseElement):
    ...
    def _create_text(
        ...
        :param bindparams:
          ...
          .. deprecated:: 0.9 the
             :paramref:`_expression.TextClause.bindparams` parameter
        ...
        :param typemap:
          ...
          .. deprecated:: 0.9  The :paramref:`_expression.TextClause.typemap`
             argument is
    ...
    def bindparams(self, *binds, **names_to_values):
        ...
        .. versionadded:: 0.9.0 The :meth:`_expression.TextClause.bindparams`
           method
    ...
    def columns(self, selectable, *cols, **types):
        ...
        .. versionadded:: 0.9.0 :func:`_expression.text`
           ...
           ``typemap`` argument to :func:`_expression.text`.
...
def _is_column(col):
    """True if ``col`` is an instance of :class:`_expression.ColumnElement`. """
