...
For custom configurations, the parameters can be specified as shown in the following examples::
    ...
    from sqlalchemy.dialects.oracle import VectorIndexType, VectorDistanceType, VectorIndexConfig
...
from .types import VectorStorageFormat
    ...
    def __post_init__(self):
        ...
        for field in [
            ...
            if value is not None and not isinstance(value, int):
                raise TypeError(
                    f"{field} must be an integer if provided, got {type(value).__name__}"
                )
