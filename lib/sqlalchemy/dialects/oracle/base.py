...
Data can be inserted into a sparse vector using a SQLAlchemy :class:`.SparseVector`
object consisting of the number of dimensions, an array of indices, and a
