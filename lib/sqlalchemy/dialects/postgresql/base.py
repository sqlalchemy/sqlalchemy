...
class PGDialect(default.DefaultDialect):
    ...
    def _reflect_type(
        ...
        print("attype", attype, "schema_type", schema_type)
    ...
    def _get_columns_info(self, rows, domains, enums, schema):
        ...
        for row_dict in rows:
            ...
            if isinstance(coltype, DOMAIN) and not default:
                # domain can override the default value but cant set it to None
