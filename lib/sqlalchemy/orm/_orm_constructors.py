...
def mapped_column(
    ...
    **dialect_kwargs: Any,
    ...
    :param default_factory: Specific to
     ...
     method as generated by the dataclass process.
    :param compare: Specific to :ref:`orm_declarative_native_dataclasses`,
     defines if this field will be considered within comparision methods
     (``__eq__``, ``__gt__``, etc.) generated by the dataclass process.
