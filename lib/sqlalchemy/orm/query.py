...
class Query(object):
    ...
    def get(self, ident):
        ...
        :param ident: A scalar or tuple value representing
         ...
         to that of the mapped :class:`_schema.Table` object's
    ...
    def join(self, *props, **kwargs):
        ...
        **Advanced Join Targeting and Adaption**
        ...
        :func:`.alias` and :func:`_expression.select` constructs,
        with either the one
    ...
    def _join(self, keys, outerjoin, full, create_aliases, from_joinpoint):
        ...
        for idx, arg1 in enumerate(keylist):
            ...
            if isinstance(onclause, interfaces.PropComparator):
                ...
                if isinstance(alias, ORMAdapter) and alias.mapper.isa(
                    left_entity
                ):
