...
class AttributeImpl(object):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :param readonly:
          a readonly attribute cannot be set by the user, but is generated by
          the database on loading. Example of readonly attributes are
          :func:`.column_property` and :class:`.Computed` columns
