...
class CoreFixtures:
    ...
    fixtures = [
        ...
        lambda: (
            func.array_agg([1, 2]), 
            func.array_agg([3, 4]),
            func.array_agg(table_a.c.a),
            func.array_agg(table_b.c.a),
            func.array_agg(aggregate_order_by(table_a.c.a, table_a.c.b)),
            func.array_agg(aggregate_order_by(table_b.c.a, table_b.c.b)),
            func.array_agg(aggregate_order_by(table_a.c.a, table_a.c.a.desc())),
            func.array_agg(aggregate_order_by(table_b.c.a, table_b.c.b.desc())),
        ),
        lambda: (
            func.json_arrayagg([1, 2]),
            func.json_arrayagg([3, 4]),
            func.json_arrayagg(table_a.c.a),
            func.json_arrayagg(table_b.c.a),
            func.json_arrayagg(aggregate_order_by(table_a.c.a, table_a.c.b)),
            func.json_arrayagg(aggregate_order_by(table_b.c.a, table_b.c.b)),
        ),
        lambda: (
