...
class LegacyOperatorTest(fixtures.TestBase):
    def test_issue_5429_operators(self):
        ...
        assert operators.ColumnOperators.is_not == operators.ColumnOperators.isnot
        # not_in
        assert hasattr(operators.ColumnOperators, 'not_in')  # modern
        assert hasattr(operators.ColumnOperators, 'notin_')  # legacy
        assert operators.ColumnOperators.not_in == operators.ColumnOperators.notin_
    ...
    def test_issue_5429_assertions(self):
        ...
        assert hasattr(assertions, 'notin_')  # legacy
        assert assertions.not_in is assertions.notin_
