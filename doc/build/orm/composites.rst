...
applied against each field name to generate the corresponding column name::
    ...
    class Person(Base):
        ...
        home_address: Mapped[Address] = composite(Address, column_template="home_%s")
        work_address: Mapped[Address] = composite(Address, column_template="work_%s")
