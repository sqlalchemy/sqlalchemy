.. change::
    ...
    The new :attr:`.SchemaConst.REFLECTED_ONLY` marker, available to any
    construct that uses :attr:`.DefaultDialect.construct_arguments`, keeps
    these values out of DDL options and out of
    :attr:`.Index.dialect_kwargs`, while constructors continue to accept
    them for compatibility with consumers of Inspector results.
